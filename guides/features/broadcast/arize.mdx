---
title: Arize AX
description: Send traces to Arize AX
seoTitle: 'Broadcast to Arize AX | OpenRouter Observability'
og:site_name: OpenRouter Documentation
og:title: 'Broadcast to Arize AX - Send Traces to Arize AX'
og:description: 'Connect Arize AX to automatically receive traces from your OpenRouter requests. Step-by-step setup guide for Arize AX integration.'
og:image: https://openrouter.ai/dynamic-og?title=Arize%20AX%20Broadcast&description=Send%20traces%20to%20Arize%20AX
og:image:width: 1200
og:image:height: 630
...
[Arize AX](https://arize.com) is an evaluation and observability platform developed by Arize; it offers tools for agent tracing, evals, prompt optimization, and more. New to this space? You can [learn more in our agent evaluation guide](https://arize.com/guides/ai-agent-handbook/agent-evaluation/) to help get started. 
...
<Frame>
![Enable Broadcast](/assets/guides/features/broadcast/arize/broadcast-enable.png)
</Frame>
...
<Frame>
![Arize Trace View](/assets/guides/features/broadcast/arize/broadcast-arize-trace.png)
</Frame>
